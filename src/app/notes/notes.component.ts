...
export class NotesComponent
	...
	constructor(private notesService: NotesService, private  messageServiceExt: MessageServiceExt,
			...
			this.notesService.saveOrUpdateNote(this.note).subscribe(value => {
				...
				if (this.note.notesId == null) {
					this.messageServiceExt.addMessageWithTime(
					    'success', 'Status', 'Dodano notatkę', 1000);
				} else {
					this.messageServiceExt.addMessageWithTime(
					    'success', 'Status', 'Edytowano notatkę', 1000);
				}
			}, error => {
